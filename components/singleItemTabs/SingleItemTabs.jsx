...
function a11yProps(index) {
  ...
  return (
    <Box sx={{ width: '100%'}}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider', display:'flex', justifyContent:'center', backgroundColor:'#101010'}}>
      ...
      <CustomTabPanel style={{backgroundColor:'#141414'}} value={value} index={0}>
      <div
